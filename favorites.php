...
<main id="favorites-page" class="container">
    <div class="browse-header">
        <h1 class="text-2xl">Favorites</h1>
        <div style="display:flex;align-items:center;gap:1rem;">
            <span id="favorites-count" class="result-count"></span>
            <button id="clear-favorites-btn" class="btn btn-ghost btn-sm"
                    style="font-size:0.8rem;color:var(--c-red);">Clear All</button>
        </div>
    </div>

    <div id="favorites-results" class="browse-grid"></div>

    <div id="favorites-empty" hidden style="text-align:center;padding:5rem 2rem;color:var(--c-text-3);">
        <div style="font-size:3rem;margin-bottom:1rem;opacity:0.3;">&#9825;</div>
        <div style="font-size:1.1rem;font-weight:600;color:var(--c-text-2);margin-bottom:0.5rem;">No favorites yet</div>
        <p style="margin-bottom:1.5rem;">Tap + Favorites on any title to save it here.</p>
        <a href="/browse" class="btn btn-primary">Browse Titles</a>
    </div>
</main>
